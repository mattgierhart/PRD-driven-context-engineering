...
Repo root: `/private/tmp/claude-501/-Users-mattgierhart-Documents-MLG-Github-PRD-driven-context-engineering--claude-worktrees-funny-easley-cba54b/9eccb5e9-5e46-460d-b511-b9f70caeb86a/scratchpad/impeccable` (paths below are relative to it).
...
| Pattern | Count | Note |
|---|---|---|
| `[reference/x.md](reference/x.md)` from SKILL.src.md | 32 links → 31 unique files | Every command row carries exactly one; native variants add a second (`audit.native.md`, `adapt.native.md`) |
