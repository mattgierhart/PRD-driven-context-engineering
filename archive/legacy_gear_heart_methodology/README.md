...
Getting Started
1) Copy `docs/templates/COMMAND_CENTER_template.md`, `PRD_template.md`, and `EPIC-template.md` into your product folder and fill them in.
2) Use `docs/workflow/WORKFLOW_MASTER.md` to run the 5‑phase loop and gates.
