...
**Inputs:** Monetization Briefs produced under the [PRD v0.3 Research Agent Instructions](./research_agents.md), including artifacts, candidate CFD-/BR-/KPI- IDs, and lifecycle notes.
