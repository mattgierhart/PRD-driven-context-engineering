...
- `API-045` in consumer file `SoT/SoT.API_CONTRACTS.md` - POST /payments/charge
- `API-046` in consumer file `SoT/SoT.API_CONTRACTS.md` - POST /subscriptions/create

**Business Rules affected**:
- `BR-101` in consumer file `SoT/SoT.BUSINESS_RULES.md` - Payment retry policy
...
**Affects Tables**: `DBT-015` in consumer file `SoT/SoT.DATA_MODEL.md`
