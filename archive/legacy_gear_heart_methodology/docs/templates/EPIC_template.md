...
related_files:
  ...
  - "product-PRD_template.md - Product requirements source"
  - "WORKFLOW_MASTER.md - Overall workflow authority"
  - "TECH_STACK_BLUEPRINT.md - Technology decisions"
---
...
- **Required Reading** (use anchors only):
  - `TECHNICAL_ARCHITECTURE.md#detailed-stack-components` (if exists)
...
- **Required Reading** (use anchors only):
  - `testing_playbook.md#coverage-requirements`
  - `COMMAND_CENTER.md#single-source_of_truth-table` (test metrics)
...
- **Additional Updates** (as applicable):
    - [ ] Update `deployment_playbook.md` if deployment procedures changed
    - [ ] Update `testing_playbook.md` with new test strategies discovered
...
**See [Testing Playbook Template](testing_playbook-template.md#mobile-testing) for comprehensive mobile testing checklist**
...
| 2025-07-20 | Mobile | 0 | 0 | 0% | See testing_playbook-template.md |
...
### Related Documents
- [WORKFLOW_MASTER.md](../workflows/WORKFLOW_MASTER.md) - Overall workflow
