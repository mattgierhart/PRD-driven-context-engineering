...
provenance: "Produced by an external deep-research agent from the key-moments canon artifact and the visual-expression research prompt (session prd-ce-v2, 2026-08-13). Vendored verbatim; consumed by docs/V2_KEY_MOMENTS.md (v1.2: per-moment Visual expression blocks, §§2.1–2.3, §4)."
---
