...
date: 2026-08-13
origin: "Owner-articulated 2026-08-13 from 20 years of enterprise product management; mapped into the ontology by this document."
companions:
  - "docs/ECOSYSTEM_ONTOLOGY.md §2.4 (the surface layer)"
  - "docs/DELIVERABLES_CONCEPT.md (the deliverable mechanism: two species, round-trip loop)"
  - "docs/V2_SKILL_CONSOLIDATION_AUDIT.md (the playbook/policy-pack inventory these moments draw on)"
scope_guard: "Defines the canon's structure and ontology placement only. No SoT IDs minted; questions-per-moment research explicitly out of scope for this document."
---
...
value test), impeccable Northstar analysis (expression patterns worth borrowing). Research input
