...
#### What It Does
Parses all SoT files (BUSINESS_RULES.md, API_CONTRACTS.md, USER-JOURNEYS.md, etc.) and renders an **interactive force-directed graph** showing:
...
#### What It Does
Parses PRD.md and workflows/PRD-VERSION-LIFECYCLE.md to render a **visual progress indicator** showing:
- Current gate (e.g., v0.6 Architecture)
- Checklist completion percentage per gate (workflows/PRD-VERSION-LIFECYCLE.md:93-153)
...
│  Modified: DEP-027, deployment-playbook.md          │
...
- EPIC Section 3A claims TEST-303 created → verify it's in testing-playbook.md
