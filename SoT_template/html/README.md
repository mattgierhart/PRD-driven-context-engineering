...
Repository maintainers may render separate example screenshots, but downstream seeds intentionally
ship no maintainer screenshot assets. Whenever these pages change (new entries replacing
placeholders, style changes, or a new page), downstream teams can generate their own renders:
