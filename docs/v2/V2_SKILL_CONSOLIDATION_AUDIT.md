...
date: 2026-08-12
method: "13 parallel deep-readers over ~43,000 lines (every SKILL.md, reference, asset, hook implementation, rule, and persona file), each producing a per-skill richness ledger. Raw ledgers: temp/v2-audit/inventory/. Companion: docs/v2/ECOSYSTEM_ONTOLOGY.md (the plane/verb model this audit executes against)."
...
> [`temp/v2-audit/inventory/`](audit/inventory) — one per skill group plus
...
> [`docs/v2/audit/impeccable-northstar.md`](audit/impeccable-northstar.md), with four
...
MUST-NOT-LOSE lists: [`temp/v2-audit/inventory/`](audit/inventory). Companion model:
[`docs/v2/ECOSYSTEM_ONTOLOGY.md`](ECOSYSTEM_ONTOLOGY.md).
