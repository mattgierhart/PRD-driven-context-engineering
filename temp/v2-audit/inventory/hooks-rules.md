...
Scope: 15 files in `.claude/hooks/` (6 wired hooks, 2 libraries, 1 doc-only spec, contract, shared helper), `settings.json`, 8 files in `.claude/rules/`. All paths relative to `/Users/mattgierhart/Documents/MLG.Github/PRD-driven-context-engineering/.claude/worktrees/funny-easley-cba54b/.claude/`.
