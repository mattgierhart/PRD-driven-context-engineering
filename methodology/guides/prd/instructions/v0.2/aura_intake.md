...
**Inputs:** Research bundles created with the [PRD v0.2 Research Agent Instructions](./research_agents.md). Assume each bundle contains validated Segment Cards, Summary Sheet, artifact links, and candidate CFD-/BR- IDs.
