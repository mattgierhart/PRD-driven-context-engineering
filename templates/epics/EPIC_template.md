...
authority: Pair with `workflows/PRD_VERSION_LIFECYCLE.md` for gate rituals and reviews.
---
...
- **Gate Criteria References**: See [`workflows/PRD_VERSION_LIFECYCLE.md`](../workflows/PRD_VERSION_LIFECYCLE.md) (consult section for v0.{x}).
...
|----|------|----------|-------------|--------|------|-------------|
| TEST-### | Test | testing_playbook.md | {Purpose} | ✅ | YYYY-MM-DD | API-### |
...
> Update `.codex/ID_REGISTRY.md` (or equivalent) after each working session.
