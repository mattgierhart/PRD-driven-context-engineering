...
- [`workflows/PRD_VERSION_LIFECYCLE.md`](../../workflows/PRD_VERSION_LIFECYCLE.md)
...
2. Confirm extraction into the right SoT files (`source_of_truth/*.md`).
...
- [`source_of_truth/README.md`](../../source_of_truth/README.md)
