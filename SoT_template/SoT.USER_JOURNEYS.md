...
> **Status**: Uninitialized template — no PER, SCR, or UJ records are accepted
...
- `UJ-XXX` - {Primary journey for this persona}
...
- `UJ-XXX` - {Journey containing this screen}
...
- `PER-XXX` - {Persona taking this journey}
- `SCR-XXX` - {Screens in this journey}
