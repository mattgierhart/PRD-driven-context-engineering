...
extracted_from: WORKFLOW-MASTER.md
last_updated: 2025-09-03
note: WORKFLOW-MASTER.md remains the authoritative overview
---

# 📋 APOLLO WORKFLOW PHASES - Detailed Execution Guide

> **Authority**: WORKFLOW-MASTER.md defines the workflow  
...
```markdown
Task for deployment-playbook-creator:
...
- **[WORKFLOW-MASTER.md](WORKFLOW-MASTER.md)** - Workflow overview
...
*This detailed phase guide expands on WORKFLOW-MASTER.md. For gate criteria and validation requirements, see WORKFLOW-GATES.md.*