...
value disagreements. Used by the SubagentStop memory hook and available as a
manual or pre-commit validation helper.
...
Usage:
  ...
  Direct:      python3 .claude/hooks/metrics_drift_check.py
  Plugin:      python3 "${CLAUDE_PLUGIN_ROOT}/hooks/metrics_drift_check.py"
