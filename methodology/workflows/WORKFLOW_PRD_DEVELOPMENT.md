...
> **Companion Docs**: [`PRD_VERSION_LIFECYCLE.md`](PRD_VERSION_LIFECYCLE.md), [`PROGRESSIVE_DOCUMENTATION_GUIDE.md`](PROGRESSIVE_DOCUMENTATION_GUIDE.md), [`UNIQUE-ID-SYSTEM.md`](UNIQUE-ID-SYSTEM.md), [`templates/product/product-PRD_template.md`](../templates/product/product-PRD_template.md).
...
- [`docs/REPO_ORGANIZATION.md`](../docs/REPO_ORGANIZATION.md) — Folder scaffolding for copy-ready repos.
