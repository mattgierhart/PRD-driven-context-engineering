...
3. Cross-reference the specialized guides when needed:
   - Lifecycle gates: [`PRD-VERSION-LIFECYCLE.md`](./PRD-VERSION-LIFECYCLE.md)
...
├── source-of-truth/       # ID-based specifications (BR-/UJ-/API-/...)
...
Use `docs/REPO-ORGANIZATION.md` for additional guidance when copying the repository into a new product workspace.
...
See [`PRD-VERSION-LIFECYCLE.md`](./PRD-VERSION-LIFECYCLE.md) for the full table and gate checklists.
...
### Sub-Agent Registry
Document research and specialist sub-agents in `agents/` or the dedicated [`SUBAGENT-REGISTRY.md`](./SUBAGENT-REGISTRY.md). Each entry should list:
...
4. **Validate** — Run automated tests, update `testing-playbook.md`, confirm gate checklist.
...
- Lifecycle workflow: `workflows/PRD-VERSION-LIFECYCLE.md`
...
- Repo copying guide: `docs/REPO-ORGANIZATION.md`
