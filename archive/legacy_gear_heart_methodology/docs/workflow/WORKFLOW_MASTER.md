...
- **Progressive Documentation**: [PROGRESSIVE_DOCUMENTATION_GUIDE.md](./PROGRESSIVE_DOCUMENTATION_GUIDE.md)

### 📚 Workflow Component Documents
**This document provides the overview. For detailed execution:**
- **[WORKFLOW_PHASES.md](WORKFLOW_PHASES.md)** - Detailed phase execution guides
...
| 5 - Deployment | deployment_playbook-creator | github-repo-manager, **vercel-mcp**, **puppeteer-mcp** |
...
**Process**: APOLLO evaluates technical requirements using [TECH_STACK_BLUEPRINT.md](../tech-stack/TECH_STACK_BLUEPRINT.md)
...
**Timeline**: 1-2 context windows over 2-3 days  
**Owner**: deployment_playbook-creator + Specialized Subagents  
...
- **Create Focused Documents**:
  - `MOBILE_DEVELOPMENT.md` in tech-stack/
...
- **Branch Protection Rules**: Explicitly define in GIT_WORKFLOW.md
...
1. **Immediate (Week 1)**:
   ...
   - Add branch protection rules to GIT_WORKFLOW.md
...
- **[product-PRD_template.md](../templates/product-PRD_template.md)** - Product requirements template
...
- **[MOBILE_DEVELOPMENT.md](../tech-stack/MOBILE_DEVELOPMENT.md)** - Mobile app standards
