...
authority: This is a SoT file - IDs created here are referenced by PRD.md, USER_JOURNEYS.md, BUSINESS_RULES.md, EPICs
---
...
> **Cross-References**: Referenced by PRD.md, USER_JOURNEYS.md, BUSINESS_RULES.md, EPICs
...
- [UJ-XXX](USER_JOURNEYS.md#uj-xxx) - {Journey where issue occurs}
...
**Database Impact**:
- [DBT-XXX](ACTUAL_SCHEMA.md#dbt-xxx) - {Table that needs schema changes}
...
*End of customer_feedback.md - This SoT file is the authoritative source for all CFD-XXX IDs*
