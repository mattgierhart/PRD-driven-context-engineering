...
> **ID Prefix**: BR-XXX
> **Status**: Uninitialized template — no BR records are accepted
...
*End of SoT.BUSINESS_RULES.md — canonical BR record location once activated and accepted; currently template structure only.*
