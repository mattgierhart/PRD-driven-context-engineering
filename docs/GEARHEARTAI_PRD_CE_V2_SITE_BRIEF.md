...
companions:
  - "docs/V2_KEY_MOMENTS.md (v1.2) and docs/V2_KEY_MOMENTS_VISUAL_RESEARCH.md — the canon this site publishes"
  - "docs/ECOSYSTEM_ONTOLOGY.md §2.4 (surfaces) and §4 (the public loop vocabulary)"
  - "docs/V2_GO_LIVE_POLISH_PLAN.md — the repo-side go-live plan this brief pairs with"
  - "temp/v2-audit/v2-walkthrough.html — the owner's private walkthrough; a future public page once re-tokenised"
---
