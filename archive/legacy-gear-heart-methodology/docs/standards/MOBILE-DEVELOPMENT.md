...
- Follow the 4-tier secrets management strategy from [SECRETS-MANAGEMENT.md](./SECRETS-MANAGEMENT.md)
...
- [FILE-STRUCTURE.md](./FILE-STRUCTURE.md) - Directory organization
- [GIT-WORKFLOW.md](./GIT-WORKFLOW.md) - Version control practices
- [SECRETS-MANAGEMENT.md](./SECRETS-MANAGEMENT.md) - Environment variables
