...
- `docs/ghm_visualization_suite_plan.md` - Full 12-week roadmap
- `docs/ghm_visualization_suite_review.md` - CODEX's technical review
...
- `workflows/PRD_VERSION_LIFECYCLE.md` - v0.1 → v1.0 lifecycle gates
...
- `workflows/PRD_VERSION_LIFECYCLE.md` (gate checklists at lines 93-153)
...
- Parse gates directly from `PRD_VERSION_LIFECYCLE.md` (don't duplicate checklists)
...
**Key Files to Read:**
- `docs/ghm_visualization_suite_plan.md` (lines 200-600: Phase 2-4 specs)
- `docs/ghm_visualization_suite_review.md` (CODEX's full review)
- `workflows/PRD_VERSION_LIFECYCLE.md` (gate structure)
...
- **SoT:** Source of Truth files (BUSINESS_RULES, API_CONTRACTS, USER_JOURNEYS, etc.)
