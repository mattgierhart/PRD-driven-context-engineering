...
- **Workflow Reference**: Follow [`../workflows/PRD_VERSION_LIFECYCLE.md`](../workflows/PRD_VERSION_LIFECYCLE.md) for gate definitions and review rituals.
...
- **Testing Baseline**: Minimum coverage — Statement ≥80%, Branch ≥75%, Function ≥85%, Line ≥80%. Record evidence in `testing_playbook.md` (TEST-XXX).
...
- Log the incident in `deployment_playbook.md` (DEP-XXX) with timestamp + mitigation steps.
